...
SOURCE := discrepancy_one_flips.tex
...
warnings: manuscript
	@if grep -En 'Overfull|Underfull|LaTeX Warning|Package .* Warning|undefined references|Citation .* undefined' discrepancy_one_flips.log; then \
		exit 1; \
	fi
